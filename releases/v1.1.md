...
| :---------- | :----------: | :----------: |  
| infrastructure | [0.10.0](https://github.com/COPRS/infrastructure/releases/tag/0.10.0) |0.10.0 |  
| production-common | [1.4.1](https://github.com/COPRS/production-common/releases/tag/1.4.1) |1.4.1 |  
| user-web-client | [1.4.0](https://github.com/COPRS/user-web-client/releases/tag/1.4.0) |1.4.0 |  
| processing-sentinel-1 | [1.4.1](https://github.com/COPRS/processing-sentinel-1/releases/tag/1.4.1) |1.4.1 |  
| processing-sentinel-2 | [1.0.0](https://github.com/COPRS/processing-sentinel-2/releases/tag/1.0.0) |1.0.0 |  
| processing-sentinel-3 | [1.4.1](https://github.com/COPRS/processing-sentinel-3/releases/tag/1.4.1) |1.4.1 |  
| monitoring | [1.1.0](https://github.com/COPRS/monitoring/releases/tag/1.1.0) |1.1.0 |
...
[38 - Assess component compliance to the non-functional requirements for Cloud Deployment and Configuration](https://github.com/COPRS/rs-issues/issues/38)  
...
[623 - [BUG] [OPS] AIO preparation job stuck in GENERATING state with mandatory files not found](https://github.com/COPRS/rs-issues/issues/623)  
